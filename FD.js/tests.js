   ...
   {   name: 'test_naive',
    ...
    },
    {
        ...
        script: function (S) {
            S.decl('S1_m', [[1,2]]);
            S.decl('S1_a', [[1,2]]);
            S.decl('T1', [S.plus('S1_m'), S.plus('S1_a')]);
            S.decl('T2', [[S.plus('S1_m'), S.plus('S1_a')]]);

            S.neq('S1_m', 'S1_a');
            S.neq('T1', 'T2');

            FD.distribute.split(S, 'S1_a');
            FD.distribute.split(S, 'S1_m');
            FD.distribute.split(S, 'T1');
            FD.distribute.split(S, 'T2');
            return S;
        }
    },
    {   name: 'test_sudoku',
